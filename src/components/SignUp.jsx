...
const SignUp = () => {
  ...
  return (
    <div className=" bg-violet-200">
      <div className="w-full max-w-md p-8  space-y-3 rounded-xl mx-auto dark:text-gray-100">
        ...
        <div className="flex  justify-center space-x-4">
          <button
            className="inline-flex gap-3 items-center rounded-full border-2 border-[#171515] bg-[#171515] px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-transparent hover:text-[#171515] focus:outline-none focus:ring active:opacity-75"
        ...
        >
          ...
          <Link to={"/signIn"} className=" font-bold dark:text-blue-800">
            {" "}
            Sign In
          </Link>
        </p>
